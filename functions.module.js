...
let f_o_code_autoextended__from_s = function(s){
    ...
    let s_start_tag__extended = '//code_autoextender_start'
    let s_end_tag__extended = '//code_autoextender_end'
    
    let s_start_tag__autoextended = '//code_autoextender_autogenerated_start'
    let s_end_tag__autoextended = '//code_autoextender_autogenerated_end'
